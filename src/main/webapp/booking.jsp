    	...
    	<div id="form_container_inner2">
    		<div id="form_container_inner3">
    		  ...
    		  <c:forEach var="ticket_up_form" items="${ticket_details}">
    			...
    			<form class="bus_detail_ticket_form" action="update_ticket_control_servlet" method="POST" id="ticketForm">
					...
					<div class="bus_img_container">
						...
						<input type="text" name="" value="${ticket_up_form.bs_id}" id="bs_id" class="bs_id_input" style="width: 60px;" disabled>
						<input type="hidden" name="up_t_bs_id" value="${ticket_up_form.bs_id}" id="bs_id" class="bs_id_input" style="width: 60px;" >
					...
					<div class="field_container">
						<div class="field1">
							...
							<input type="text" name="up_t_s_time" value="${ticket_up_form.start_time}" id="s_time" class="s_time" style="margin-left:13px;">
							
							<br>
							<label for="from">Origin</label>
							<input type="text" name="up_t_origin" value="${ticket_up_form.origin}" id="from" class="from">
							
						</div>
						
						<div class="field2">
							<label for="date">Date</label>
							<input type="date" name="up_t_date" id="date" class="date" value="${ticket_up_form.date}">
							...
							<input type="text" name="up_t_duration" value="${ticket_up_form.duration}" id="duration" class="duration">
							
						</div>
						
						<div class="field3">
							<label for="e_time" style="padding-left:17px;">End Time</label>
							<input type="text" name="up_t_e_time" value="${ticket_up_form.end_time}" id="e_time" class="e_time" style="margin-left:13px;">
							
							<br>
							<label for="destination">Destination</label>
							<input type="text" name="up_t_destination" value="${ticket_up_form.destination}" id="destination" class="destination">
					...
					<div class="button_container">
						...
						<input type="number" name="up_t_seat_no" style="width: 40px;" class="seat_no" min="1" value="${ticket_up_form.seat_no}">
						<br>
						<label for="price">Price</label>
						<input type="text" name="up_t_price" value="${ticket_up_form.price}" id="price" style="width: 94px;" class="price">
						
						<br>
						<input type="submit" name="submit" value="Book" class="submit_btn" onclick="hide_update()" style=" width: 60px; height: 25px;">
    				...
    				<div id="confirm_btns">
    					...
    					<c:forEach var="ticket_de_form" items="${ticket_details}">
	    					...
	    					<form action="delete_ticket_control_servlet" method="POST" id="delete_confirm_form">
	    						...
	    						<input type="submit" value="Yes, Cancel" name="submit" id="cancel"  class="con_btn">
	    					</form>
		        ...
		        <div id="payment_form_div">
		            ...
		            <form action="index.jsp" method="POST" style="padding-top:25px" id="form4">
		                ...
		                <label for="card_number" id="align_numbr_icons">
		                    <img src="img/icons/credit-card.png" class="payment_icons" style="width:20px; top: -2px;">
		                </label>
		                ...
		                <div style=" text-align: center;">
		                    ...
		                    <label for="check_box" style="top: -2px; font-size: 11px; color: black; display: inline; position: relative;">
		                ...
		                <div id="div_pay_btn">
		                    <input type="submit" name="payment" value="Proceed to Pay" id="pay_btn" required onclick="success()">
		                </div>
