...
<body>
	...
	<section id="terms">
	    <div class="container">
	        ...
	        <p>Welcome to BusSwap. By accessing this website, you agree to comply with and be bound by the following terms and conditions:</p>
	        <ol>
	            <li>This website is owned and operated by BusSwap.</li>
	            <li>These terms and conditions govern your use of this website; by using this website, you accept these terms and conditions in full.</li>
	            ...
	            <li>This website uses cookies. By using this website and agreeing to these terms and conditions,
	             you consent to BusSwap's use of cookies in accordance with the terms of BusSwap's privacy policy.</li>
	        ...
	        <p>BusSwap reserves the right to revise these terms and conditions at any time without notice. By using this
