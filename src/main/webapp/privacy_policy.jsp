	...
	<div id="privacy_main_container">
		...
		<main>
	        <section id="introduction">
	            <h2>Introduction</h2>
	            <p>Welcome to BusSwap's Privacy Policy. This policy outlines how we collect, use, and protect your personal information when you use our website.</p>
	        </section>
	        <section id="information-collected">
	            <h2>Information We Collect</h2>
	            <p>We may collect the following types of personal information:</p>
	            <ul>
	                <li>Information you provide voluntarily, such as when you create an account or make a reservation.</li>
	                <li>Information collected automatically, including your IP address, browser type, and browsing behavior.</li>
	                <li>Information collected from third-party sources, such as social media platforms if you choose to link your account.</li>
	            </ul>
	        </section>
