...
public class search_result_util 
{
	...
	public static List<bus_detail> search(String origin, String destination)
	{
		...
		try
		{
			...
			while(resu.next())
			{
				...
				bus_detail bus1 = new bus_detail(id_var, origin_var, destination_var, start_time_var, end_time_var, duration_var, seats_var, price_var);
	...
	//////////////////////////insert ticket details to database/////////////////////////////////////////////
	
	public static boolean insertTicketDetails(int tid, String p_bsId, String p_sTime, String p_origin, String p_date, String p_duration, String p_eTime, String p_destination, int p_seatNo, String p_price)
	{
		...
		try
		{
			...
			if(reslt > 0)
			{
				...
				//System.out.println("The ID of the specific row inserted is: " + lastInsertedId);
				getLastInsertedId();
			}
			else
			{
...
/////////////////////////////////////DISPLAY TICKET DEATAILS  ///////////////////////////////////////
	...
	public static List<ticket_details> getTicketDetails(int tbl_id)
	{
		...
		try
		{
			...
			if(reslt.next())
			{
				...
				ticket_details ticket_obj = new ticket_details(t_id, bs_id, s_time, origin, date, duration, e_time,  destination,  seat_no,  price);
	...
	public static boolean updateTicketDetails(int up_tid, String up_bs_id, String up_s_time, String up_origin, String up_date, String up_duration, String up_e_time, String up_destination, int up_seat_no, String up_t_price)
	{
		...
		try
		{
			...
			String sql = "UPDATE tickets SET bus_id='"+up_bs_id+"', s_time='"+up_s_time+"', origin='"+up_origin+"', date='"+up_date+"', duration='"+up_duration+"', e_time='"+up_e_time+"', destination='"+up_destination+"', seat_no='"+up_seat_no+"', price='"+up_t_price+"'"
							+ "WHERE t_id='"+up_tid+"' ";
