...
public class ticket_control_servlet extends HttpServlet 
{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		else {  t_seat_no = Integer.parseInt(request.getParameter("t_seat_no")) ; 
		}
		...
		{
			check_success = search_result_util.insertTicketDetails(t_t_id, t_bs_id, t_st_time, t_bs_origin, t_date, t_duration, t_en_time, t_bs_destination, t_seat_no, t_price);
			
			if(check_success == true)
			{
				
				//List<ticket_details> ticketDetails = search_result_util.getTicketDetails(t_t_id);
